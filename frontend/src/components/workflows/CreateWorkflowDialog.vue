...
interface Emits {
  ...
  (e: 'create', data: CreateWorkflowData): void
}
  ...
  <Dialog :open="open" @update:open="(val) => !val && handleCancel()">
    <DialogContent class="max-w-3xl max-h-[90vh] overflow-y-auto">
      <DialogHeader>
        ...
        <DialogDescription>
          Create a complete workflow with trigger and actions. All fields are validated before
          creation.
        </DialogDescription>
      </DialogHeader>
      ...
      <DialogFooter>
        ...
        <Button @click="handleCreate">Create Workflow</Button>
      </DialogFooter>
    </DialogContent>
  </Dialog>
</template>
